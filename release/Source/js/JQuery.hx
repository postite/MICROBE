...
extern class JQuery implements ArrayAccess<Dom.HtmlDom> {
	...
	@:overload(function (f : Int -> Dynamic->Void):JQuery{}) //postite add
	...
	@:overload(function(events : String, callb : JqEvent -> Void->Dynamic):JQuery{}) //postite addon
	@:overload(function(events : String,param:Array<Dynamic>, callb : JqEvent -> Void):JQuery{}) //postite addon
	...
	@:overload(function(events : String,data:Dynamic):JQuery{})//postite addon
	function trigger( events : String ) : JQuery;
	function triggerHandler( events : String ) : JQuery;
	
	@:overload(function(?events : String,?data:Array<Dynamic>, ?callb : JqEvent -> Void):JQuery{})//postite addon
