...
extern class ScrollableView extends JQuery {
	
	
	public static function __init__():Void {
  untyped __js__("var ScrollableView = window.jQuery");
	}
	public function scrollintoview(?option:SerialScrollOptions) :SerialScroll;
