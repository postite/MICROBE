...
class controllers_Upload implements haxe_rtti_Infos, haxigniter_server_Controller{
	...
	static $__rtti = "<class path=\"controllers.Upload\" params=\"\">\x0A\x09<implements path=\"haxe.rtti.Infos\"/>\x0A\x09<implements path=\"haxigniter.server.Controller\"/>\x0A\x09<appConfig line=\"29\" static=\"1\"><c path=\"config.Config\"/></appConfig>\x0A\x09<appDebug line=\"32\" static=\"1\"><c path=\"haxigniter.server.libraries.Debug\"/></appDebug>\x0A\x09<main public=\"1\" set=\"method\" line=\"91\" static=\"1\"><f a=\"\"><e path=\"Void\"/></f></main>\x0A\x09<requestHandler public=\"1\"><c path=\"haxigniter.server.request.RequestHandler\"/></requestHandler>\x0A\x09<contentHandler public=\"1\"><c path=\"haxigniter.server.content.ContentHandler\"/></contentHandler>\x0A\x09<config public=\"1\" set=\"null\"><c path=\"config.Config\"/></config>\x0A\x09<view public=\"1\" set=\"null\"><c path=\"haxigniter.server.views.ViewEngine\"/></view>\x0A\x09<debug public=\"1\"><c path=\"haxigniter.server.libraries.Debug\"/></debug>\x0A\x09<index public=\"1\" set=\"method\" line=\"47\"><f a=\"\"><e path=\"Void\"/></f></index>\x0A\x09<show public=\"1\" set=\"method\" line=\"52\"><f a=\"id\">\x0A\x09<c path=\"Int\"/>\x0A\x09<e path=\"Void\"/>\x0A</f></show>\x0A\x09<create public=\"1\" set=\"method\" line=\"58\"><f a=\"posted:?files:?bytes\">\x0A\x09<c path=\"Hash\"><c path=\"String\"/></c>\x0A\x09<c path=\"Hash\"><c path=\"haxigniter.server.request.FileInfo\"/></c>\x0A\x09<c path=\"Int\"/>\x0A\x09<e path=\"Void\"/>\x0A</f></create>\x0A\x09<trace set=\"method\" line=\"86\"><f a=\"data:?debugLevel:?pos\">\x0A\x09<d/>\x0A\x09<e path=\"haxigniter.server.libraries.DebugLevel\"/>\x0A\x09<t path=\"haxe.PosInfos\"/>\x0A\x09<e path=\"Void\"/>\x0A</f></trace>\x0A\x09<new public=\"1\" set=\"method\" line=\"36\"><f a=\"\"><e path=\"Void\"/></f></new>\x0A</class>";
	static $appConfig;
	static $appDebug;
