...
class microbe_Api {
	...
	public function recClassMap() {
		...
		if($this->map->id !== null) {
			...
			haxe_Log::trace("MONID=" . $voInstance->id, _hx_anonymous(array("fileName" => "Api.hx", "lineNumber" => 333, "className" => "microbe.Api", "methodName" => "recClassMap")));
		}
		haxe_Log::trace("after", _hx_anonymous(array("fileName" => "Api.hx", "lineNumber" => 337, "className" => "microbe.Api", "methodName" => "recClassMap")));
