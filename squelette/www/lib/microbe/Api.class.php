...
class microbe_Api implements haxe_rtti_Infos{
	...
	public function recClassMap() {
		haxe_Log::trace("record" . _hx_string_rec($this->map->id, ""), _hx_anonymous(array("fileName" => "Api.hx", "lineNumber" => 323, "className" => "microbe.Api", "methodName" => "recClassMap")));
		$voInstance = null;
		if($this->map->id !== null) {
			haxe_Log::trace("map.id!=null", _hx_anonymous(array("fileName" => "Api.hx", "lineNumber" => 326, "className" => "microbe.Api", "methodName" => "recClassMap")));
		...
		haxe_Log::trace("after", _hx_anonymous(array("fileName" => "Api.hx", "lineNumber" => 333, "className" => "microbe.Api", "methodName" => "recClassMap")));
	...
	public function getLast($_vo, $search = null) {
		...
		try {
			...
			if(is_string($msg = $_ex_)){
				haxe_Log::trace("Error occurred: " . $msg, _hx_anonymous(array("fileName" => "Api.hx", "lineNumber" => 217, "className" => "microbe.Api", "methodName" => "getLast")));
			} else throw $»e;;
		}
		if(_hx_len($all) > 0) {
