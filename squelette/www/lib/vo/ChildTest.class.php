...
class vo_ChildTest extends sys_db_Object implements microbe_vo_Spodable{
	...
	public function getFormule() {
		...
		$formule->set("modele", _hx_anonymous(array("classe" => "microbe.form.elements.Mock", "type" => microbe_form_InstanceType::$formElement, "champs" => $this->image)));
		return $formule;
	}
	public $rel;
	public $modele;
	...
	function __toString() { return 'vo.ChildTest'; }
}
vo_ChildTest::$__meta__ = _hx_anonymous(array("obj" => _hx_anonymous(array("rtti" => new _hx_array(array("oy4:namey5:childy7:indexesahy9:relationsaoy4:lockfy4:propy3:rely4:typey15:vo.RelationTesty7:cascadefy6:isNullfy3:keyy3:ridghy7:hfieldsby5:imageoR0R14R10fy1:tjy15:sys.db.SpodType:9:1i255gy2:idoR0R17R10fR15jR16:0:0gR12oR0R12R10fR15jR16:1:0gy3:pozoR0R18R10fR15r10gy5:titreoR0R19R10fR15jR16:9:1i255gy6:modeleoR0R20R10fR15jR16:9:1i255ghR11aR17hy6:fieldsar11r7r12r5r14r9hg"))))));
vo_ChildTest::$manager = new vo_ChildManager(_hx_qtype("vo.ChildTest"));
