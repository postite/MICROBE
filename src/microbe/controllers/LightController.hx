...
class LightController implements haxigniter.server.Controller #if !haxe3 , implements haxe.rtti.Infos #end
{
	...
	public static var appConfig = new Config();
	...
	|		
	*/
//	private static var appView = new haxigniter.server.views.Templo(appConfig,null,true);//!(Web.getHostName() == 'localhost') || (Web.getHostName() == '127.0.0.1'));
// private static var appView = new haxigniter.server.views.ErazorView(appConfig);
	/*
